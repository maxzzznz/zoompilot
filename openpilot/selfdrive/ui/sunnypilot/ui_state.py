...
class UIStateSP:
  ...
  def update_disengaged_screen_off_timer(self) -> None:
    ...
    # is changing a setting; begin a fresh timeout after navigation returns to the camera.
    if not self.started or not self.disengaged_screen_off or self.engaged or gui_app.menu_active:
